...
public class ProcessoSeletivo {
    ...
    static void imprimirSelecionados() {
        String [] candidatos = {"FELIPE","MARCIA","JULIA","AUGUSTO"};
        System.out.println("Imprimir a lista de candidatos informado o indice do elemento");
    ...
    static void selecaoCandidatos(){
        String [] candidatos = {"FELIPE","MARCIA","JULIA","AUGUSTO","MONICA","FABRICIO","DANIELA","JORGE"};
